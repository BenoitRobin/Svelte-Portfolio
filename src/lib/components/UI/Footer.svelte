<footer class="footer">
	<div class="footer-container">
		<h3 class="semi-bld mb-xs">Benoit Robin</h3>
		<div class="mb-l">
			<a href="https://github.com/BenoitRobin" target="_blank" class="footer-link" aria-label="GitHub"><i class="devicon-github-original"></i></a>
